...
> sapphirechain uses websocket for p2p communication, but it was dropped to simplify the understanding of message exchange. It is relying only on REST communication.
...
It's the starting point to interact with the sapphire, and every node provides a swagger API to make this interaction easier. Available endpoints:
...
```sh
# Run a node
$ node bin/sapphire.js

# Run two nodes
$ node bin/sapphire.js -p 3001 --name 1
$ node bin/sapphire.js -p 3002 --name 2 --peers http://localhost:3001
...
# Run sapphire in a docker
$ ./dockerExec.sh

# Run sapphire in a docker using port 3002
$ ./dockerExec.sh -p 3002

# Run sapphire in a docker options
$ ./dockerExec.sh -h
...
$ node bin/sapphire.js -h
Usage: bin\sapphire.js [options]
...
```sh
# Clonning repository
$ git clone git@github.com:conradoqg/sapphire.git
$ cd sapphire
$ npm install
...
[![Twitter](https://img.shields.io/twitter/url/https/github.com/conradoqg/sapphire.svg?style=social)](https://twitter.com/intent/tweet?text=Check%20it%20out%3A%20sapphire%20-%20a%20cryptocurrency%20implementation%20in%20less%20than%201500%20lines%20of%20code&url=%5Bobject%20Object%5D)

[![GitHub license](https://img.shields.io/badge/license-Apache%202-blue.svg)](https://raw.githubusercontent.com/conradoqg/sapphire/master/LICENSE)
